...
import { getArtisansByIds, acceptBid, getJobById, raiseDispute } from '../../services/api';
...
const JobStatusView: React.FC<JobStatusViewProps> = ({ jobRequest: initialJobRequest, onBack, onRefreshJob }) => {
